    ...
    config = {
        ...
        js: {
            concat: [
                ...
                dirNodeModules + 'slick-carousel/slick/slick.js',
                dirNodeModules + 'bootstrap-sass/assets/javascripts/bootstrap/tab.js',
                dirNodeModules + 'bootstrap-sass/assets/javascripts/bootstrap/transition.js',
                dirNodeModules + 'simplebar/dist/simplebar.js',
...
gulp.task('run-web-server', function () {
    connect.server({
        root: ['public'],
        port: config.port,
